...
from isaaclab_arena_vln.policy.vln_env_wrapper import VLNEnvWrapper
...
def load_navila_low_level_policy(
    ...
    """
    # Delayed imports — these require the simulation app to be running
    from rsl_rl.runners import OnPolicyRunner
    from isaaclab.utils.io import load_yaml

    # Also try the history wrapper from NaVILA-Bench if available,
    # otherwise fall back to the standard RSL-RL wrapper.
    try:
